...
%% Read data
% 输入路径：指向 COS-7 MT PFBT&BODIPY565 的 tif 数据
input_tif = 'E:/data/wu_chang_feng/20260606/COS-7 MT PFBT&BODIPY565/MT PFBT&BODIPY565_1.tif';
image0 = double(imstackread(input_tif));
